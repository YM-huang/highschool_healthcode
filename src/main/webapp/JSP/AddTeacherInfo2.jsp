            ...
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <form target="hid" style="position:fixed; left: 1200px" action="<%=path%>/queryTeacherServlet">
                        <input type="text" name="tno" class="ser-text pull-left" placeholder="学号" />
                                                ...
                                                <div class="accordion-inner">
                                                    <form action="<%=path%>/addTeacherServlet">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <td>职称：</td><td><input type="text" name="tprofess"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>权限等级：</td><td><input type="text" name="role"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>电话：</td><td><input type="text" name="tphone"></td>
                                                            </tr>
                                                            <tr>
