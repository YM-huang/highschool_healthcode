...
<%@page import="com.model.StuClass" %>
...
<div class="bt-warp bge6">
    ...
    <div class="main-content">
        <div class="container-fluid" style="padding-bottom: 66px;">
            ...
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <form target="hid" style="position:fixed; left: 1200px" action="<%=path%>/QueryoneClassServlet">
                        <input type="text" name="classno" class="ser-text pull-left" placeholder="班级号" />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 pull-left pd0">
                <div class="p17">
                    <div class="bgw" style="height:491px">
                        <div class="title c6 f16 plr15">班级信息</div><br>
                        <table class="table table-bordered table-condensed" contenteditable="false">
                            ...
                            <tbody>
                            <c:forEach var="stuclass" items="${requestScope.stuclass}"
                                       varStatus="status">
                                ...
                                <td>${stuclass.classno}</td>
                                <td>${stuclass.classname}</td>
                                <td>
                                    <a href="<%=path%>/JSP/ModifyClassInfo.jsp?classno=${stuclass.classno}&classname=${stuclass.classname}">修改</a>
                                    <a href="<%=path%>/deleteClassServlet?classno=${stuclass.classno}">删除</a>
                                </td>
                                </tr>
                            </c:forEach>
                            <tr>
                                <td rowspan="9"><a href="<%=path%>/JSP/AddClassInfo2.jsp">添加</a></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
