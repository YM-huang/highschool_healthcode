...
<%@page import="com.model.StuCollege" %>
        ...
        <div class="container-fluid" style="padding-bottom: 66px;">
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <a class="plr10 c4" href="<%=path%>/queryAllTeacherServlet">首页</a>>>学院信息管理</span>
                </div>
            </div>
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <form target="hid" style="position:fixed; left: 1200px" action="<%=path%>/QueryoneCollegeServlet">
                        <input type="text" name="collegeno" class="ser-text pull-left" placeholder="学院号" />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 pull-left pd0">
                <div class="p17">
                    <div class="bgw" style="height:491px">
                        <div class="title c6 f16 plr15">学院信息</div><br>
                        <table class="table table-bordered table-condensed" contenteditable="false">
                            ...
                            <tbody>
                            <c:forEach var="college" items="${requestScope.college}"
                                       varStatus="status">
                                ...
                                <td>${college.collegeno}</td>
                                <td>${college.collegename}</td>
                                <td>
                                    <a href="<%=path%>/JSP/ModifyCollegeInfo.jsp?collegeno=${college.collegeno}&collegename=${college.collegename}">修改</a>
                                    <a href="<%=path%>/deleteCollegeServlet?collegeno=${college.collegeno}">删除</a>
                                </td>
                                </tr>
                            </c:forEach>
                            <tr>
                                <td rowspan="9"><a href="<%=path%>/JSP/AddCollegeInfo2.jsp">添加</a></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
