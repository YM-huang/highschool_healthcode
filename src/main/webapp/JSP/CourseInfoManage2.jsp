        ...
        <div class="container-fluid" style="padding-bottom: 66px;">
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <a class="plr10 c4" href="<%=path%>/queryAllTeacherServlet">首页</a>>>课程信息管理</span>
                </div>
            </div>
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <form target="hid" style="position:fixed; left: 1200px" action="<%=path%>/queryCourseServlet">
                    ...
                    <div class="bgw" style="height:491px">
                        ...
                        <table class="table table-bordered table-condensed" contenteditable="false">
                            ...
                            <c:forEach var="course" items="${requestScope.course}"
                                ...
                                <td>${course.cterm}</td>
                                <td>${course.chour}</td>
                                <td>${course.cassessment}</td>
                                <td>${course.ccredit}</td>
                                <td>
                                    <a href="<%=path%>/JSP/ModifyCourseInfo.jsp?cno=${course.courseno}&cname=${course.coursename}&cterm=${course.cterm}&ctime=${course.chour}&cway=${course.cassessment}&ccredit=${course.ccredit}">修改</a>
                                    <a href="<%=path%>/deleteCourseServlet?cno=${course.courseno}&cname=${course.coursename}&cterm=${course.cterm}&ctime=${course.chour}&cway=${course.cassessment}&ccredit=${course.ccredit}">删除</a>
                                </td>
                                </tr>
                            </c:forEach>
                            <tr>
                                <td rowspan="9"><a href="<%=path%>/JSP/AddCourseInfo2.jsp">添加</a></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
