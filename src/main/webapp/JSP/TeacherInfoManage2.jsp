                    ...
                    <div class="bgw" style="height:491px">
                        ...
                        <table class="table table-bordered table-condensed" contenteditable="false">
                            ...
                            <c:forEach var="teacher" items="${requestScope.teacher}"
                                ...
                                <td>${teacher.tpass}</td>
                                <td>
                                    <a href="<%=path%>/JSP/ModifyTeacherInfo.jsp?tno=${teacher.tno}&tname=${teacher.tname}&tsex=${teacher.tsex}&tage=${teacher.tage}&tprofess=${teacher.tprofess}&tphone=${teacher.tphone}&tpass=${teacher.tpass}">修改</a>
                                    <a href="<%=path%>/deleteTeacherServlet?tno=${teacher.tno}">删除</a>
                                </td>
                                </tr>
                            </c:forEach>
                            <tr>
