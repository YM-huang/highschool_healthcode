        ...
        <div class="container-fluid" style="padding-bottom: 66px;">
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <a class="plr10 c4" href="<%=path%>/JSP/allAdministrators2.jsp">首页</a>>>班级信息管理</span>
                </div>
            </div>
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                                    ...
                                    <div class="accordion-group">
                                        ...
                                        <div class="accordion-body collapse" id="accordion-element-66275">
                                            <div class="accordion-inner">
                                                <form action="<%=path%>/addClassServlet">
                                                    <table>
                                                        <tr>
                                                            <td>班级编号：</td><td><input type="text" name="classno"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>班级名：</td><td><input type="text" name="classname"></td>
                                                        </tr>
                                                        <tr>
