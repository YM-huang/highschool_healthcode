        ...
        <div class="container-fluid" style="padding-bottom: 66px;">
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <a class="plr10 c4" href="<%=path%>/JSP/allAdministrators2.jsp">首页</a>>>专业信息管理</span>
                </div>
            </div>
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 pull-left pd0">
                <div class="p17">
                    <div class="bgw" style="height:491px">
                        <div class="title c6 f16 plr15">专业信息</div><br>
                        <div class="row-fluid">
                            <div class="span12">
                                    ...
                                    <div class="accordion-group">
                                        ...
                                        <div class="accordion-body collapse" id="accordion-element-66275">
                                            <div class="accordion-inner">
                                                <form action="<%=path%>/addMajorServlet">
                                                    <table>
                                                        <tr>
                                                            <td>学院编号：</td><td><input type="text" name="collegeno"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>专业编号：</td><td><input type="text" name="mno"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>专业名：</td><td><input type="text" name="mname"></td>
                                                        </tr>
                                                        <tr>
