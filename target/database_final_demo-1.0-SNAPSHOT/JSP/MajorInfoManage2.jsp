        ...
        <div class="container-fluid" style="padding-bottom: 66px;">
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <a class="plr10 c4" href="<%=path%>/queryAllTeacherServlet">首页</a>>>专业信息管理</span>
                </div>
            </div>
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <form target="hid" style="position:fixed; left: 1200px" action="<%=path%>/QueryoneMajorServlet">
                        <input type="text" name="mno" class="ser-text pull-left" placeholder="专业号" />
                ...
                <div class="p17">
                    <div class="bgw" style="height:491px">
                        ...
                        <table class="table table-bordered table-condensed" contenteditable="false">
                            ...
                            <tbody>
                            <c:forEach var="major" items="${requestScope.major}"
                                       varStatus="status">
                                ...
                                <td>${major.mname}</td>
                                <td>
                                    <a href="<%=path%>/JSP/ModifyMajorInfo.jsp?collegeno=${major.collegeno}&mname=${major.mname}&mno=${major.mno}">修改</a>
                                    <a href="<%=path%>/deleteMajorServlet?mno=${major.mno}">删除</a>
                                </td>
                                </tr>
                            </c:forEach>
                            <tr>
                                <td rowspan="9"><a href="<%=path%>/JSP/AddMajorInfo2.jsp">添加</a></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
