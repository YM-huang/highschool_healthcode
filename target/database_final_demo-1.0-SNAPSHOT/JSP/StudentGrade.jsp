...
<%@page import="com.model.Studentgrade" %>
        ...
        <div class="container-fluid" style="padding-bottom: 66px;">
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <a class="plr10 c4" href="<%=path%>/queryAllTeacherServlet">首页</a>>>学生成绩查询</span>
                </div>
            </div>
            <div class="pos-box bgw mtb15">
                <div class="position f14 c9 pull-left">
                    <form target="hid" style="position:fixed; left: 1200px" action="<%=path%>/queryoneStudentCourseServlet">
                        <input type="text" name="sname" class="ser-text pull-left" placeholder="姓名" />
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 pull-left pd0">
                <div class="p17">
                    <div class="bgw" style="height:491px">
                        <div class="title c6 f16 plr15">学生成绩信息</div><br>
                        <table class="table table-bordered table-condensed" contenteditable="false">
                            ...
                            <tbody>
                            <c:forEach var="grade" items="${requestScope.grade}"
                                       varStatus="status">
