                    ...
                    <div class="bgw" style="height:491px" >
                        ...
                        <table class="table table-bordered table-condensed" contenteditable="false">
                            ...
                            <c:forEach var="student" items="${requestScope.student}"
                                ...
                                <td>${student.ssex}</td>
                                <td>${student.sage}</td>
                                <td>${student.shometown}</td>
                                <td>${student.scredit}</td>
                                <td>${student.spwd}</td>
                                <td>
                                    <a href="<%=path%>/JSP/ModifyStudentInfo.jsp?sno=${student.sno}&sname=${student.sname}&classno=${student.classno}&sage=${student.sage}&sex=${student.ssex}&shometown=${student.shometown}&scredit=${student.scredit}&spwd=${student.spwd}">修改</a>
                                    <a href="<%=path%>/deleteStudentServlet?sno=${student.sno}&sname=${student.sname}&classno=${student.classno}&sage=${student.sage}&sex=${student.ssex}&shometown=${student.shometown}&scredit=${student.scredit}&spwd=${student.spwd}">删除</a>
                                </td>
                                </tr>
                            </c:forEach>
                            <tr>
