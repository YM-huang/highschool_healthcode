...
<div class="login">
    <div class="account">
        <div class="logo">教师职务修改界面</div>
        <form action="../manageTeacherRoleServlet" method="post">
            <div class="line" >
                <input class="inputtxt" value="<%=request.getParameter("name")%>" name="name" id="name" datatype="*"
                       placeholder="姓名" type="text" readonly>
            </div>
